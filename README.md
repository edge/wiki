...
Edge is the world's first dedicated edge network. A blockchain for edge computing, with a computational layer and a series of services on top. Edge makes use of the spare capacity all around us, meaning it's greener than the cloud, and faster too.
...
{% hint style="info" %}
**This is a living document that is regularly updated. Last update: 28th September 2023**
{% endhint %}
